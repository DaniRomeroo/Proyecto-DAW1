...
const editView = ( i, pelicula ) => {
    return `<h2>Editar Película </h2>
                ...
                <div class="field">
                Fecha estreno <br>
                <input  type="text" id="fecha" placeholder="Fecha estreno" 
...
const showView = ( pelicula ) => {
    return `
            ...
            fue dirigida por <b> ${pelicula.director}</b> y estrenada el <b> ${pelicula.fecha}</b>!
...
const updateContr = ( i ) => {
    ...
    mis_peliculas[ i ].fecha = document.getElementById( 'fecha' ).value;
